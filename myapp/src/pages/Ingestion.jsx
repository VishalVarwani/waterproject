...
export default function Ingestion() {
  ...
  return (
    <div className="ingestion"> {/* ← add this wrapper */}
    <div className="section">
      ...
      <div className="card" style={{padding:0}}>
        <div className="toolbar" style={{ gap: 8, flexWrap: 'wrap' }}>
          ...
          <button className="button" onClick={doMap} disabled={busy}>Map & Harmonize</button>
        ...
        {preview && (
          <div className="ingest-preview" style={{ padding: 16 }}>
            ...
            {availableSheets?.length ? (
              <p><strong>Available sheets:</strong> {availableSheets.join(', ')}</p>
            ) : null}
